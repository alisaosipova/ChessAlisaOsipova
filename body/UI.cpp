...
UI::UI() {
    Storage::getPtr()->setRoot("C:/Users/SABIR/source/repos/chess/data");
...
void UI::updateWindowTitle() {
    ...
    case STATUS::WHITE_TO_MOVE:
        this->window.setTitle(L"Ваш ход");
        break;
    case STATUS::BLACK_TO_MOVE:
        this->window.setTitle(L"Компьютер думает...");
        break;
    case STATUS::WHITE_WON:
        this->window.setTitle(L"Вы победили");
        break;
    case STATUS::BLACK_WON:
        this->window.setTitle(L"Вы проиграли");
        break;
    case STATUS::DRAW:
        this->window.setTitle(L"Ничья");
        break;
    }
}
